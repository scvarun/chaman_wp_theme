...
if ( ! function_exists( 'unifato_theme_scripts' ) ) {
  add_action( 'wp_enqueue_scripts', 'unifato_theme_scripts' );
    ...
    wp_enqueue_style( 'rollyjs-css', 'https://unpkg.com/rolly.js@0.2.1/css/style.css', false, THEME_VERSION, true);
    wp_enqueue_script( 'rollyjs', 'https://unpkg.com/rolly.js@0.2.1/dist/rolly.min.js', array('jquery'), THEME_VERSION, true);
